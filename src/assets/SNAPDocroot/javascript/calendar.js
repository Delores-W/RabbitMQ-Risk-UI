...
//AM - clear the date
	ggWinContent += ("[<A HREF=\"javascript:void(0);\" " +
		"onMouseOver=\"window.status='Clear the Date'; return true;\" " +
		"onMouseOut=\"window.status=''; return true;\" " +
		"onClick=\"document." + this.gReturnItem + ".value='';ggPosX=-1;ggPosY=-1;nd();nd();"+
		"\">Clear<\/A>]");
//-end AM	
...
/*
Calendar Code Starts here for Allocation validity date.
*/
function show_calendarForValidityDate() {
	/* 
		p_month : 0-11 for Jan-Dec; 12 for All Months.
		p_year	: 4-digit year
		p_format: Date format (mm/dd/yyyy, dd/mm/yy, ...)
	...
	*/
	...
	if (arguments[1] == null)
		...
		p_month = arguments[1];
	if (arguments[2] == "" || arguments[2] == null)
		p_year = new String(''+(gNow.getFullYear()+3));
	else
		p_year = arguments[2];
	if (arguments[3] == null)
		p_format = "YYYY-MM-DD";
